...
<body>
<form action="{{route('Manager_artical_doadd')}}" method="post" id="form">
    {{csrf_field()}}
                ...
                <ul>
                    <li class="clearfix Mandatory">
                        ...
                        <span class="formControls col-10">
                            <input name="title" type="text" value="{{old('title')}}" id="title" class="col-xs-10 col-sm-5 ">
                        </span>
                    </li>
                    <li class="clearfix Mandatory">
                        <label class="label_name">
                            <i>*</i>文章简介</label>
                        <span class="formControls col-10">
                            <input name="desc" type="text" value="{{old('desc')}}" id="desc" class="col-xs-10 col-sm-6 ">
                        </span>
                    </li>
                    <li class="clearfix">
                        <label class="label_name">排序</label>
                        <span class="formControls col-10">
                            <input type="text" name="sort" value="{{old('sort')}}" id="sort" class="col-xs-10 col-sm-1">
                        </span>
                    </li>
                    <li class="clearfix">
                        <label class="label_name">
                        ...
                        <span class="formControls col-4">
                            ...
                            @foreach($artical_types as $artical_type)
                               <option value="{{$artical_type->id}}">{{$artical_type->type_name}}</option>
                            @endforeach
                            </select>
                        </span>
                    </li>
                    <li class="clearfix">
                        ...
                        <span class="formControls col-10"><script id="editor" name="content" type="text/plain" style="width:100%;height:400px; margin-left:10px;"></script></span>
