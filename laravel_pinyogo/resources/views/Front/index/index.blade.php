@extends("Front/layouts/head") @section('head')
		...
		<div class="yui3-g SortList ">
			<div class="yui3-u Left all-sort-list">
				<div class="all-sort-list2">
					@foreach($goods_types as $k=>$one)
					<div class="item <?php if($k==0)echo 'bo'; ?> ">
						<h3>
							<a href="">{{$one->goods_type}}</a>
						</h3>
						<div class="item-list clearfix">
							<div class="subitem">
								@foreach($one->level_twos as $k=>$two)
								<dl class="fore{{$k+1}}">
									<dt>
										<a href="">{{$two->goods_type}}</a>
									</dt>
									<dd>@foreach($two->level_threes as $three)
										<em>
											<a href="">{{$three->goods_type}}</a>
										</em>@endforeach</dd>
								</dl>
								@endforeach
							</div>
			...
			<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
				...
				<li class="yui3-u-1-6">
					<dl class="picDl tuhua">
						...
						<dd>
							<a href="" class="pic">
								<img nsrc="assets/img/like_02.png" alt="" />
							</a>
							<div class="like-text">
								<p>三星（G5500）</p>
								<p>移动联通双网通</p>
				...
				<li class="yui3-u-1-6">
					<dl class="picDl jilu">
						<dd>
							<a href="http://sc.chinaz.com/" class="pic">
								<img src="img/like_03.png" alt="" />
							</a>
							<div class="like-text">
								<p>捷波朗 </p>
			...
			<div class="yui3-u row-165 brandArea">
				...
				<ul class="yui3-g brand-list">
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand01.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand02.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand03.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand04.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand05.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand06.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand07.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand08.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
						<img src="img/brand09.png" />
					</li>
					<li class="yui3-u-1-2 brand-pit">
...
<!--楼层-->
@foreach($goods_types as $k=>$level_one)
<div id="floor-{{$k+1}}" class="floor">
	<div class="py-container">
		<div class=" floors">
			<h3 class="fl">{{$level_one->goods_type}}</h3>
			<div class="fr">
				<ul class="sui-nav nav-tabs">
					@foreach($level_one->level_twos as $kk=>$level_two)
					<li class="<?php if($kk==0) echo 'active';?>">
						<a href="#tab{{$level_two->id}}" data-toggle="tab">{{$level_two->goods_type}}</a>
					</li>
					@endforeach
				</ul>
			</div>
		...
		<div class="clearfix  tab-content floor-content">
			@foreach($level_one->level_twos as $kkk=>$level_two)
			<div id="tab{{$level_two->id}}" class="tab-pane <?php if($kkk==0) echo 'active';?>">
				<div class="yui3-g Floor-1">
					...
					<div class="yui3-u row-330 floorBanner">
						<div id="floorCarousel{{$level_two->id}}" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
							<ol class="carousel-indicators">

								<li data-target="#floorCarousel{{$level_two->id}}" data-slide-to="0" class="active"></li>
								<li data-target="#floorCarousel{{$level_two->id}}" data-slide-to="1"></li>
								<li data-target="#floorCarousel{{$level_two->id}}" data-slide-to="2"></li>
							</ol>
							<div class="carousel-inner">
							
							@if(json_decode($level_two->ads)!=[])
							@foreach($level_two->ads as $kkkk=>$ad)
								<div class="item <?php if($kkkk==0) echo 'active';?>">
									<img style="width:329px;height:360px;" src="{{Storage::url($ad->ad_logo)}}">
								</div>
							@endforeach
							@else
							   <div class="item">
							...
							<a href="#floorCarousel{{$level_two->id}}" data-slide="prev" class="carousel-control left">‹</a>
							<a href="#floorCarousel{{$level_two->id}}" data-slide="next" class="carousel-control right">›</a>
						</div>
					</div>
					@endif
				@foreach($level_two->goods as $good)
					<div  onclick="location.href='{{route('Front_item')}}?goods_id={{$good->id}}'" style="cursor:pointer;color:red;font-size:20px;text-align:center;" class="yui3-u row-218 split">
						<span style="display:block;margin:10px 0px;" >{{$good->goods_name}}</span>
						<img src="{{Storage::url($good->image['logo'])}}" />
					</div>
				@endforeach
				</div>
			</div>
...
<script type="text/javascript" src="js/widget/nav.js"></script> @endsection('head')