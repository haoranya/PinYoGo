		...
		<div class="top">
			<div class="py-container">
				<div class="shortcut">
					...
					<ul class="fr">
						<li class="f-item"> <a href="Front_home_index">我的订单</a> </li>
						<li class="f-item space"></li>
						<li class="f-item"><a href="{{ route('Front_home_index') }}" target="_blank">我的品优购</a></li>
						<li class="f-item space"></li>
						...
						<li class="f-item" id="service">
							<span>客户服务</span>
							<ul class="service">
								<li><a href="{{ route('Front_cooperation') }}" target="_blank">合作招商</a></li>
								<li><a href="shop{{ route('Front_login') }}" target="_blank">商家后台</a></li>
								<li><a href="{{ route('Front_cooperation') }}" target="_blank">合作招商</a></li>
								<li><a href="#">商家后台</a></li>
							</ul>
						</li>
			...
			<div class="py-container">
				<div class="yui3-g Logo">
					<div class="yui3-u Left logoArea">
						<a class="logo-bd" title="品优购" href="JD-{{ route('Front_index') }}" target="_blank"></a>
					</div>
					...
					<div class="yui3-u Right shopArea">
						<div class="fr shopcar">
							<div class="show-shopcar" id="shopcar">
								<span class="car"></span>
								<a class="sui-btn btn-default btn-xlarge" href="{{ route('Front_cart') }}" target="_blank">
									<span>我的购物车</span>
									<i class="shopnum">0</i>
								</a>
				...
				<div class="yui3-g NavList">
					...
					<div class="yui3-u Center navArea">
						<ul class="nav">
							...
							<li class="f-item"><a href="{{ route('Front_seckill_index') }}" target="_blank">秒杀</a></li>
						</ul>
					</div>
